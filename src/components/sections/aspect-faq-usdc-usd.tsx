...
const faqs = [
  {
    question: 'Can I send USDC directly to a U.S. dollar bank account?',
    answer:
      'Yes. We convert USDC → USD and pay out to your corporate USD account via wire/SWIFT (and ACH where supported). Timing is shown before you confirm.',
  },
  {
    question: 'Do you support USD → USDC as well?',
    answer:
      "Yes. Two-way is available where supported. If a direct route isn't policy-approved in your region, we'll offer a compliant alternative.",
  },
  {
    question: 'How fast is USDC → USD?',
    answer:
  ...
  {
    question: 'Which networks are supported for USDC?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes. Use the API for quotes, execution, and pulling receipts/statements.',
  },
];

const AspectFaqUsdcUsd = () => {
  return (
      ...
      <div className="container border border-transparent p-0">
        <div className="px-6 md:px-16">
          <h2 className="text-foreground mb-12 text-3xl font-bold md:text-6xl">
            FAQs <span className="text-[#cbff00]">(USDC → USD)</span>
          </h2>
...
export default AspectFaqUsdcUsd;
