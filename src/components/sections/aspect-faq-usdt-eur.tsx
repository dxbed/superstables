...
const faqs = [
  {
    question: 'Can I send USDT directly to a European bank account?',
    answer:
      'Yes. We convert USDT → EUR and payout to your IBAN (SEPA) in supported regions, with timing shown before you confirm.',
  },
  {
      ...
      <div className="container border border-transparent p-0">
        <div className="px-6 md:px-16">
          <h2 className="text-foreground mb-12 text-3xl font-bold md:text-6xl">
            FAQs <span className="text-[#cbff00]">(USDT → EUR)</span>
          </h2>
...
export default AspectFaqUsdtEur;
