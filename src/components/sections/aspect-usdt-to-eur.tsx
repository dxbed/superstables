          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <div className="mb-12 text-center">
              <h1 className="text-foreground mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
                ...
                <span className="mb-2 block text-[#cbff00]">USDT → EUR</span>
            ...
            <div className="mb-12 flex items-center justify-center">
              <div className="flex items-center gap-4 md:gap-8">
                ...
                {/* EUR */}
                <div className="text-center">
                  <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#003399] to-[#002266] shadow-lg md:h-20 md:w-20">
                    <span className="text-lg font-bold text-white md:text-xl">
                      €
                    </span>
                  </div>
            ...
            <div className="mx-auto mb-12 grid max-w-4xl gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-[#cbff00]/20 bg-[#cbff00]/5 p-6 transition-colors hover:bg-[#cbff00]/10">
                ...
                <p className="text-mid-gray text-sm">
                  SEPA transfer to your IBAN • Same/next day
                </p>
              </div>
              ...
              <div className="rounded-lg border border-[#cbff00]/20 bg-[#cbff00]/5 p-6 transition-colors hover:bg-[#cbff00]/10">
                ...
                <p className="text-mid-gray text-sm">
                  Receive EURC in your wallet • Instant
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <p className="text-mid-gray">
                  For USDT → EUR (bank) or USDT → EURC (wallet). See the best
                  net rate upfront.
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="rounded-lg border border-[#cbff00]/20 p-6">
                ...
                <p className="text-mid-gray mb-4">
                  Send USDT, receive euros in your company bank account. Typical
                  posting same day or next business day in supported corridors.
                </p>
              ...
              <div className="rounded-lg border border-[#cbff00]/20 p-6">
                ...
                <p className="text-mid-gray mb-4">
                  Prefer to stay on-chain? Receive EURC with the same low-bps
          ...
          <div className="px-6 md:px-16">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="text-mid-gray text-lg leading-relaxed">
                PSPs and marketplaces paying sellers, treasuries managing
                USD↔EUR exposure, funds/market makers moving collateral, and
